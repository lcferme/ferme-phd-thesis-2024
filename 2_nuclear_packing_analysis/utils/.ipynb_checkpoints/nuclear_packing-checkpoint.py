...
def radial_distribution_function_3D(x, y, z, volMask, rMax, dr, interior_indices):
    ...
    Code based on script https://github.com/cfinch/Shocksolution_Examples/blob/master/PairCorrelation/paircorrelation.py
    """
    ...
    numberDensity = (num_interior_particles / volMask )
